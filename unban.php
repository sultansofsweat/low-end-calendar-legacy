...
<html>
  <head>
    ...
    <title>Low End Calendar-Submit Unban Request</title>
  ...
  <h1>Low End Calendar-Submit Unban Request</h1>
  <form method="post" action="unban.php">
  <input type="hidden" name="s" value="y">
  <input type="hidden" name="user" value="<?php echo $user; ?>">
  Describe why you should be unbanned:<br>
